 ...
 * don't use it.
 * 
 * Please report bugs/issues to <adrian.kosowski@inria.fr>. Version: January 9, 2019
 */
...
class Test2 {
    ...
    public static void test3(String s1,String s2) {
        ...
        /*for(int i=0;i<ed.getEditDistanceDP(s1, s2).length;i++) {
        	for(int j=0;j<ed.getEditDistanceDP(s1, s2)[0].length;j++)
        		System.out.print(ed.getEditDistanceDP(s1, s2)[i][j]+"  ");
        	System.out.println();
        }*/
